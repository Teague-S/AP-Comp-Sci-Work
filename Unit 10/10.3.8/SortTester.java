...
public class SortTester {
    ...
    public static void main(String[] args) {
        ...
        // Make array
        int[] sel = makeRandomArray(100);

        // Record start time
        double start = System.currentTimeMillis();

        // Sort array using selectionSort static method
        Sorter.selectionSort(sel);
        ...
        int[] ins = makeRandomArray(100);
        start = System.currentTimeMillis();
        Sorter.insertionSort(ins);
        end = System.currentTimeMillis();
        System.out.println("Insertion Sort: " + (end - start));

        // mergeSort
        int[] mer = makeRandomArray(100);
        // same steps as above with mergeSort method.
        start = System.currentTimeMillis();
        Sorter.mergeSort(mer, mer.length);
        end = System.currentTimeMillis();
    ...
    /**
     * This method returns an array in reverse order starting from the parameter
     * number
     * and going to the value 0.
     * 
     * @param number- the length of the desired almost sorted array
     * @return array - returns an array length number. Index 0 is the value number,
     *         and
