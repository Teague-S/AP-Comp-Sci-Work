...
public class CardGameGUI extends JFrame implements ActionListener {
    ...
    private static final int DEFAULT_HEIGHT = 379;
     ...
     */
    private static final int LAYOUT_WIDTH_INC = 80;
    /**
    ...
    private static final int BUTTON_TOP = 250;
    ...
    private static final int LABEL_TOP = 250;
    ...
    private String imageFileName(Card c, boolean isSelected) {
        String str = "labs/cards/";
        if (c == null) {
            return "labs/cards/back1.GIF";
        }
        str += c.rank() + c.suit();
        if (isSelected) {
            str += "S";
